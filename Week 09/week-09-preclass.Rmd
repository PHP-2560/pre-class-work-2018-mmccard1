...
timestamp <- html_node(webpage, ".wsod_disclaimer span")
...
```{r}
blue_bars <- html_nodes(webpage, ".bars")
bar_values <- html_attr(blue_bars, "class")
bar_nums <- as.numeric(sub("bars pct", '', bar_values))
